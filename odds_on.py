...
print("Also, odds have to be a number 2 or greater because if odds are 1 thats just a dare. This is not a definite dare, we like to gamble :)")
...
if starting_it == str("okay"): 
    ...
    if give_me_odds >= 2:
        ...
        if st_number <= give_me_odds:
            ...
            print("Your number: " + str(st_number))
            print("My number: " + str(st_number))
            st_number: int = int(input("Hey, you're not within odds, try again. Enter here: "))
            if st_number > give_me_odds: 
                print("Wow if you can't follow instructions we can't play the game.")
                exit()
            else:
                st_number <= give_me_odds
                print("Your number: " + str(st_number))
        ...
        print("Odds have to be greater than 2")
        quit()
else:
    ...
    if starting_it == str("okay"): 
        ...
        if give_me_odds >= 2:
            ...
            print("You have to have odds greater than 2 to play.")
            quit()
    else:
        print("Wow, you really can't follow instructions. If you still want to play press the up arrow and enter to restart.")
        quit()